...
**MCQ create / update / delete / attempt** — see the live PRD. Phases 1–2 are **COMPLETED** (awaiting review of Phase 2). Phase 3 is **PLANNED**. Do not start the next phase until the user confirms.
