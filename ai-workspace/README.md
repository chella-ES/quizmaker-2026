...
**MCQ create / update / delete / attempt** — see the live PRD. Phases 1–3 are **COMPLETED** (awaiting review of Phase 3). Phase 4 is **PLANNED**. Do not start the next phase until the user confirms.
