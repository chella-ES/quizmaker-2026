...
**Register / login / logout** — see the live PRD. Phases 1–3 are **COMPLETED** (awaiting review of Phase 3). Phases 4–7 are **PLANNED**. Do not start the next phase until the user confirms.
